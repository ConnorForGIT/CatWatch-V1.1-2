...
-(void)getDataFromBlock:(MyBlock)block
{
    ...
    [manager GET:[NSString stringWithFormat:@"http://watch-cdn.idailywatch.com/api/list/opinion/zh-hans?page=%d&ver=iphone&app_ver=9", self.page + 1] parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
