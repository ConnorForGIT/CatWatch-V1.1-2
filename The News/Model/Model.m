...
-(void)getDataFromBlock:(MyBlock)block
{
    ...
    [manager GET:[NSString stringWithFormat:@"http://watch-cdn.idailywatch.com/api/list/magazine/zh-hans?page=%ld&ver=iphone&app_ver=9", self.page + 1] parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        [_dataModel removeLastObject];
            self.dataBlcok(_dataModel);
